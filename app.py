...
with st.expander(" Turbine Availability Debug"):
    ...
    if len(missing_turbines) > 0:
        ...
        st.write(list(missing_turbines))
    else:
        st.success("All turbines present")
...
for t in all_turbines:  #  CHANGE HERE (IMPORTANT)
